...
public class CommentsController {
    ...
    public Comments postComments(@RequestBody @Valid PostCommentsRequest request) {
        return commentsService.postComments(request.getContent(),request.getUserId(),request.getThreadId(),request.getPostedAt());
    } 
    ...
    public Comments putComments(@RequestBody PutCommentsRequest request){
        return commentsService.updateComments(request.getId(), request.getContent(),request.getPostedAt());
    }

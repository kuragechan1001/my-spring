...
public class ThreadsService{
    ...
    public Threads postThreads(String title, String content, Integer userId, LocalDateTime postedAt) {
        ...
        Users user = usersRepository.findById(userId).get();//findByIdの戻り値は勝手にOptionalの型になってるから書かなくていい
    ...
    public Threads updateThreads(Integer id, String title, String content) {

...
public class CommentsService{
    ...
    public Comments postComments(String content, Integer userId, Integer threadId,LocalDateTime postedAt) {
    ...
    public Comments updateComments(Integer id, String content,LocalDateTime postedAt) {
        ...
        if (postedAt != null) {
            ...
            comments.setPostedAt(LocalDateTime.now()); // デフォルト値を設定
        }
            return commentsRepository.save(comments); 
    }
